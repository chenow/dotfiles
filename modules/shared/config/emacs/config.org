...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "chenow"
    user-mail-address "antoine.cheneau@outlook.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/chenow/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/chenow/bin" "/profile/bin" "/Users/chenow/.npm-packages/bin" "/Users/chenow/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
